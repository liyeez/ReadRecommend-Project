...
function Reviews(props) {
    ...
    if (token) {
        ...
        getAuthReviews(); //check is user commented alrdy (get all reviews as well)
    }
    else {
        api_call =
        ;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Typography_1.default, { component: "h2", variant: "h6", color: "primary", gutterBottom: true },
            "Reviews (",
            book.n_reviews,
            ")"),
        react_1.default.createElement(Table_1.default, { size: "small" },
            ...
            react_1.default.createElement(TableBody_1.default, null, reviews.map((row) => (react_1.default.createElement(TableRow_1.default, { key: row.id },
                react_1.default.createElement(TableCell_1.default, null, row.user_name),
        ...
        react_1.default.createElement("div", { className: classes.seeMore },
            reviewFlag == 1
                ? (react_1.default.createElement(Button_1.default, { color: "primary", onClick: handleClickOpen }, "Edit your review"))
                : (null),
            reviewFlag == 0
                ? (react_1.default.createElement(Button_1.default, { color: "primary", onClick: handleClickOpen }, "Write a review"))
                : (null),
            react_1.default.createElement(Dialog_1.default, { open: openReview, onClose: handleClose, "aria-labelledby": "form-dialog-title" },
                ...
                react_1.default.createElement(DialogContent_1.default, null,
                    react_1.default.createElement(TextField_1.default, { autoFocus: true, margin: "dense", id: "name", label: "Review", type: "text", fullWidth: true, value: newReview, onChange: onTextChange }),
                ...
                react_1.default.createElement(DialogActions_1.default, null,
                    ...
                    react_1.default.createElement(Button_1.default, { onClick: saveReview, color: "primary", variant: "contained" }, "Save"),
                    reviewFlag
                        ? (react_1.default.createElement(Button_1.default, { onClick: removeReview, color: "primary", variant: "contained" }, "Delete"))
                        : (null))))));
}
