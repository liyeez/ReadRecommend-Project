...
const VpnKey_1 = __importDefault(require("@material-ui/icons/VpnKey"));
...
const Sidebar = ({}) => {
    ...
    return (react_1.default.createElement("div", { className: classes.drawerContainer },
        react_1.default.createElement(List_1.default, null,
            ...
            react_1.default.createElement(ListItem_1.default, { button: true, key: "More Books", component: Router.Link, to: "/user/recommendations" },
                react_1.default.createElement(ListItemIcon_1.default, null,
                    react_1.default.createElement(MenuBook_1.default, null)),
                react_1.default.createElement(ListItemText_1.default, { primary: 'More Books' })),
            react_1.default.createElement(ListItem_1.default, { button: true, key: "Keyword Search", component: Router.Link, to: "/keyword" },
                react_1.default.createElement(ListItemIcon_1.default, null,
                    react_1.default.createElement(VpnKey_1.default, null)),
                react_1.default.createElement(ListItemText_1.default, { primary: 'Keyword Search' })))));
};
