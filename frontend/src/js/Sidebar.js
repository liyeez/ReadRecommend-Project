        ...
        react_1.default.createElement(Drawer_1.default, { className: classes.drawer, variant: "permanent", classes: {
            ...
            react_1.default.createElement("div", { className: classes.drawerContainer },
                react_1.default.createElement(List_1.default, null,
                    ...
                    react_1.default.createElement(ListItem_1.default, { button: true, key: "(TEST) Other User Profile", component: Router.Link, to: "/user/otherusers" },
                        react_1.default.createElement(ListItemIcon_1.default, null,
                            react_1.default.createElement(LibraryBooks_1.default, null)),
                        react_1.default.createElement(ListItemText_1.default, { primary: '(TEST) Other User Profile' })),
                    react_1.default.createElement(ListItem_1.default, { button: true, key: "(TEST) Other User Collection", component: Router.Link, to: "/user/othercollections" },
                        react_1.default.createElement(ListItemIcon_1.default, null,
                            react_1.default.createElement(LibraryBooks_1.default, null)),
                        react_1.default.createElement(ListItemText_1.default, { primary: '(TEST) Other User Collection' })))))));
};
