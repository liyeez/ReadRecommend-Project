                ...
                react_1.default.createElement(Grid_1.default, { container: true, spacing: 4 },
                    extBooks.length > 0
                        ...
                        : (react_1.default.createElement(Typography_1.default, { align: 'center', component: "h5", color: "textSecondary" },
                            ...
                            "No results for ",
                            txt)),
                    extBooks.map((book) => (react_1.default.createElement(Grid_1.default, { item: true, key: book, xs: 12, sm: 6, md: 4 },
                        react_1.default.createElement(Card_1.default, { className: classes.card },
                            ...
                            react_1.default.createElement(CardActions_1.default, null,
                                react_1.default.createElement(Button_1.default, { size: "small", color: "primary", onClick: () => storeBook(book) }, "View"))))))),
                react_1.default.createElement(IconButton_1.default, { type: "submit", className: classes.iconButton, "aria-label": "search", onClick: moreResults },
                    "More Results",
