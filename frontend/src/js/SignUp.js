...
const SignUp = ({}) => {
    ...
    function onSignUp(e) {
        ...
        if (password !== confirmPassword) {
            setSignUpForm(prevSignUpForm => {
                return Object.assign(Object.assign({}, prevSignUpForm), { signUpError: 'Passwords do not match.' });
            });
        }
        else {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    setSignUpForm(prevSignUpForm => {
                        return Object.assign(Object.assign({}, prevSignUpForm), { signUpError: 'Signed up.' });
                    });
                ...
                error: function (xhr, status, error) {
                    ...
                    if (error == "Conflict") {
                        setSignUpForm(prevSignUpForm => {
                            return Object.assign(Object.assign({}, prevSignUpForm), { signUpError: 'The username is already taken. Please try again.' });
                        });
                    }
                }
            });
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(Container_1.default, { component: "main", maxWidth: "xs" },
            react_1.default.createElement("div", { className: classes.root }, (signUpForm.signUpError !== "") ? ((signUpForm.signUpError === "Signed up.") ?
                (react_1.default.createElement(Alert_1.default, { severity: "success" }, "Successfully signed up! Log in to your account here."))
                : (react_1.default.createElement(Alert_1.default, { severity: "error" }, signUpForm.signUpError))) : (null)),
            (signUpForm.signUpError === "Signed up.") ? (react_1.default.createElement(Router.Redirect, { to: "/" })) : (null),
            ...
            react_1.default.createElement("div", { className: classes.paper },
                ...
                react_1.default.createElement("form", { className: classes.form, noValidate: true },
                    react_1.default.createElement(Grid_1.default, { container: true, spacing: 2 },
                        ...
                        react_1.default.createElement(Grid_1.default, { item: true, xs: 12 },
                            react_1.default.createElement(TextField_1.default, { name: "signUpConfirmPassword", variant: "outlined", required: true, fullWidth: true, type: "password", label: "Confirm Password", value: signUpForm.signUpConfirmPassword, onChange: onTextboxChange }))),
