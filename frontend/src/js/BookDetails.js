...
function Slides(props) {
    ...
    return (react_1.default.createElement(react_material_ui_carousel_1.default, null, items.map((item) => (react_1.default.createElement(Item, { key: item.id, item: item })))));
}
function Item(props) {
