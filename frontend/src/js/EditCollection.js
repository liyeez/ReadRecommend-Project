...
const EditCollection = ({}) => {
    ...
    const [chipData, setChipData] = react_1.useState([
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("main", null,
                ...
                react_1.default.createElement(Container_1.default, { maxWidth: "sm" },
                    react_1.default.createElement(Grid_1.default, null,
                        react_1.default.createElement("div", null,
                            collectionData.editCollectionError ===
                                "Collection with the same name already exists!" ? (react_1.default.createElement(Alert_1.default, { severity: "error" }, collectionData.editCollectionError)) : null,
                            collectionData.editCollectionError ===
                                "Collection successfully renamed!" ? (react_1.default.createElement(Alert_1.default, { severity: "success" }, collectionData.editCollectionError)) : null),
                    ...
                    react_1.default.createElement("div", { className: classes.heroButtons },
                        react_1.default.createElement(Grid_1.default, { container: true, spacing: 2, justify: "center" },
                            ...
                            react_1.default.createElement(Grid_1.default, { item: true },
                                react_1.default.createElement(Button_1.default, { type: "submit", variant: "outlined", color: "primary", startIcon: react_1.default.createElement(History_1.default, null), onClick: getRecentlyAddedBooks }, "Recently Added Books")),
                            react_1.default.createElement(Grid_1.default, { item: true },
            ...
            react_1.default.createElement(Container_1.default, { className: classes.cardGrid, maxWidth: "md" },
                react_1.default.createElement(Grid_1.default, { container: true, spacing: 4 },
                    console.log(book_list),
                    book_list.map((card) => (react_1.default.createElement(Grid_1.default, { item: true, key: card.id, xs: 12, sm: 6, md: 4 },
                        react_1.default.createElement(Card_1.default, { className: classes.card },
                            ...
                            react_1.default.createElement(CardActions_1.default, null,
                                ...
                                react_1.default.createElement(Button_1.default, { size: "small", color: "primary", component: Router.Link, to: "/bookdata/metadata" }, "Edit Status"),
